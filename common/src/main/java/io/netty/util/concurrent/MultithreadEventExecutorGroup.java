...
public abstract class MultithreadEventExecutorGroup extends AbstractEventExecutorGroup {
    ...
    protected MultithreadEventExecutorGroup(int nThreads, Executor executor,
        ...
        final FutureListener<Object> terminationListener = new FutureListener<Object>() {
            ...
            public void operationComplete(Future<Object> future) throws Exception {
                // 全部关闭，当所有 EventExecutor 都终止完成时，通过调用 Future#setSuccess(V result) 方法，通知监听器们，至于为什么设置的值是 null ，因为监听器们不关注具体的结果。
    ...
    /**
     * 创建线程工厂对象，创建的对象为 DefaultThreadFactory，并且使用类名作为 poolType
     *
     * @return
     */
    ...
    /**
     * 获得 EventExecutor 数组的迭代器，为了避免调用方，获得迭代器后，对 EventExecutor 数组进行修改，所以返回的是不可变的 EventExecutor 数组 readonlyChildren 的迭代器
     *
     * @return
     */
    @Override
     ...
     *
     * 抽象方法，创建 EventExecutor 对象，子类实现该方法，创建其对应的 EventExecutor 实现类的对象
     */
